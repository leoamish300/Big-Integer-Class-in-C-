...
public:
	...
	friend istream &operator>>(istream &inp,BigInteger &A)
	{
		string st; inp>>st; A.assignDataMembers(st); return inp;
	}
	friend ostream &operator<<(ostream &oup,BigInteger &A)
	{
		if(A.sign=='-')
			oup<<A.sign<<A.str;
		else
